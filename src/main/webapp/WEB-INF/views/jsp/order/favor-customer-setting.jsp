...
<body>
<form id="form" name="form" method="post" action="<c:url value="/order/favorCustomer/setting"/>">
    <div class="main border">
        ...
        <table id="table1" width="500" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="" style="background-color: #fff">
            ...
            <tr class="header-line">
                <td height="30" align="center" valign="middle" class="favor-customer"></td>
                <td align="center" valign="middle">
                    <div>6</div>
                    <input type="checkbox" name="indexNumber" id="checkbox2" value="6"/></td>
                <td align="center" valign="middle" class="favor-customer high-light"></td>
                <td align="center" valign="middle" class="high-light">
                    <div>7</div>
                    <input type="checkbox" name="indexNumber" id="checkbox19" value="7"/></td>
                <td align="center" valign="middle" class="favor-customer"></td>
                <td align="center" valign="middle">
                    <div>8</div>
    ...
    function initFavorList() {
        $.ajax({
            ...
            success: function (data) {
                var $favorList = $(".favor-customer");
                $(data).each(function (i,n) {
                    $($favorList[n.indexNumber - 1]).text(n.customerName);
                });
            },
...
//                alert('数据加载失败' + type);
    ...
    $(function () {
        ...
        $("#del").click(function (e) {
            $("#form").attr("action", ctx + "/order/favorCustomer/delete").submit();
        })
