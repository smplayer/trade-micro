...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<c:url value="/resources/product/css/uploading-image.css"/>"/>
    <style type="text/css">
    </style>
</head>
...
<div id="container" style="padding-top: 70px;">
    <form id="form" name="form" method="post" enctype="multipart/form-data" action="<c:url value="/product/uploadImage"/>">
