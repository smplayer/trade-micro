...
<link rel="stylesheet" type="text/css" href="<c:url value="/resources/container/css/preloaded.css"/>"/>
<style type="text/css">
...
<div class="after-table-info">
    <span class="info-item" style="margin-left: 45px; ">公司名称：</span>
    <span class="info-item" style="margin-left: 70px; ">制单日期：</span>
    <span class="info-item" style="margin-left: 150px; ">制表：</span>
</div>
