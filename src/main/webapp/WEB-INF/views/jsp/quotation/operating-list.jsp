        ...
        <table style="width: 1330px;" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#333333">
            ...
            <c:forEach items="${page.dataList}" var="pvo" varStatus="status">
                <tr>
                    ...
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.factoryProductNo}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.packageForm}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.unit}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.factoryPrice}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.cartonSize}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.product.packingQuantity}" /></td>
                    <td class="break tdbg">
                        <input type="text" name="productName" value="${pvo.product.grossWeight}" />
                        /
                        <input type="text" name="productName" value="${pvo.product.netWeight}" />
                    </td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.orderedCartonQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.quotedPrice}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.orderedProductQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.totalVolume}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.totalAmount}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.packingQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.packingQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.packingQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.packingQuantity}" /></td>
                    <td class="break tdbg"><input type="text" name="productName" value="${pvo.quotationProductItem.packingQuantity}" /></td>
